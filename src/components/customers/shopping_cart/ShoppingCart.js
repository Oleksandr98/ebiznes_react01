...
class ShoppingCart extends Component {
    ...
    order(id, cId) {
        placeOrder(id, cId, {discountValue: this.state.coupon, cardId: this.state.card}).catch(error => console.log(error.response?.data.message));
    }
    ...
    render() {
        return (
            <div style={{textAlign: "left"}}>
                ...
                <p>Total price: {this.state.cart?.cart.value}</p>
